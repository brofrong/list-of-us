import { Accessor, ParentComponent, createContext, createMemo, createSignal, useContext } from "solid-js";
import { z } from "zod";
...
export const I18NProvider: ParentComponent = (props) => {
  const [selectedLocale, setSelectedLocale] = createSignal<Locale>(getLocalLocale());
